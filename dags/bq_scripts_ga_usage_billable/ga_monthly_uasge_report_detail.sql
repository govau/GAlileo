...
create or replace table `dta_ga360_usage_billing.analytics_usage_202110_report_detail`
as
SELECT  
    ...
    am.type
FROM `dta-ga-bigquery.dta_ga360_usage_billing.analytics_usage_202110` ba
...
create or replace table `dta_ga360_usage_billing.analytics_usage_202110_report`
as
SELECT  
    coalesce(am.agency,"") as agency_name,
